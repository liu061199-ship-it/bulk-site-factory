...
export const sites = [
  ...
  },
  {
    ...
    "resolvedArticles": [
      ...
      },
      {
        ...
        "excerpt": "A dated XP786 News note for Pakistan readers tracking login, register, app, download, and official access update intent after the latest GSC read.",
        "date": "2026-07-23",
        "author": "XP786 News",
        "body": [
          "The July 23 GSC read shows that XP786 News still has no reliable clicks, impressions, or query rows. The right response is not to claim demand, but to publish clearer dated coverage for the searches Pakistan readers are likely to use.",
          "This update watch focuses on login update, register update, app update, download update, official access, and mobile access intent. Each topic should link back to stable guide or review pages when the reader needs a safer next step.",
          "A useful news page should answer what changed, what has not been verified, and where the reader should continue. If there is no reliable Search Console query data, the page should say so through cautious wording and practical checks.",
          "For indexing work, keep this page in the sitemap, connect it from the News homepage article list, and submit the URL only as a crawl request. Submission is not proof that Google has indexed or ranked the page."
        ]
      },
      {
  ...
  },
  {
    ...
    "themeColor": "#f59e0b",
    "template": "tips",
    "title": "XP786 Pakistan Mobile Help | Login, Register and App Download Tips",
    "description": "Need XP786 help on mobile? Check login, registration, H5 access and app download steps for Pakistan, with quick safety checks before you continue.",
    "keywords": [
      "XP786 Tips Pakistan",
      "XP786 mobile tips",
    ...
    "resolvedArticles": [
      ...
      },
      {
        ...
        "excerpt": "Short mobile-first XP786 Tips checks for Pakistan readers using H5 pages, login buttons, register paths, and download notes on phones.",
        "date": "2026-07-23",
        "author": "XP786 Tips",
        "body": [
          "When a tips domain has zero visible GSC impressions, the page still needs to solve a real mobile problem. Pakistan readers should be able to check the page purpose, login action, register action, and download note without scrolling through repeated text.",
          "Start with the H5 basics: confirm the domain, wait for the page to finish loading, make sure the text does not overlap, and check that login and register buttons are large enough to tap on a phone.",
          "If the mobile page feels unclear, use XP786 Guide for the full access path, XP786 Hub for related resources, or XP786 Review before trusting app or download claims. A quick tip should lead to one clear next step, not trap the reader on a thin page.",
          "This July 23 tip is written for discovery and usefulness. It should be linked from the Tips article list, appear in the sitemap, and remain cautious until Search Console shows reliable clicks, impressions, or query data."
        ]
      },
      {
