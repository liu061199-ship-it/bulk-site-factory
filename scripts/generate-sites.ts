...
function buildCloudflareRedirects(sites: GeneratedSite[]) {
  ...
  if (redirectLines.length === 0) {
    return "# Auto-generated by scripts/generate-sites.ts. No redirect domains configured.\n";
  }

  return `# Auto-generated by scripts/generate-sites.ts. Do not edit by hand.
${redirectLines.join("\n")}
`;
}
...
`;
  ...
  await writeFile(path.join(publicDir, "_redirects"), buildCloudflareRedirects(generatedSites), "utf8");
